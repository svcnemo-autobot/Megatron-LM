...
def _add_mixed_precision_args(parser):
    ...
    group.add_argument(
        ...
        dest='logit_dtype',
        help=(
            'Output dtype for the language-model output-layer GEMM. When the requested dtype '
            'differs from the input dtype, Transformer Engine general_gemm is used. By default, '
            'logits use the output-layer input dtype.'
        ),
    )
    group.add_argument(
