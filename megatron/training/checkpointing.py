...
# [ModelOpt]: Import modelopt utilities.  These live in megatron.post_training
# which is NOT shipped inside the pip-installed megatron-core package, so the
# import must be guarded to avoid a ModuleNotFoundError at import time.
try:
