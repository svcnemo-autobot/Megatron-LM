...
def run_fused_qk_topk(
    ...
    del use_local_indexer_varlen, single_packed_thd_sequence, local_packed_cp_rank
...
def run_fused_qk_topk_with_loss(
    ...
    del config, use_local_indexer_varlen, single_packed_thd_sequence, local_packed_cp_rank
