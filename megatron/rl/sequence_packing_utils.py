...
def distribute_packed_bins(
    ...
    if current_bins < max_bins_per_rank:
        ...
        empty_trajs, empty_position_ids, empty_loss_mask, empty_packing_entries = create_empty_bins(
            num_empty_bins, bin_size, packed_trajs, packed_position_ids, packed_loss_mask, tokenizer
        )
...
def pack_all_trajectories(
    ...
    with nvtx_range("rl/pack-sequences", time=True):
        ...
        # Distribute packed bins across the data parallel ranks
        packed_trajs, packed_position_ids, packed_loss_mask, packing_info = distribute_packed_bins(
